###Supp4##############
#Finally, let's plot all iModulon activity with those pretty bar plots:
rec_var = {}
...
plot_regulon_histogram(ica_data, 'uncharacterized-9', ax=ax)
# Set axes labels and title
ax.set_xlabel('Gene Expression Level')
ax.set_ylabel('Frequency')
ax.set_title('')
# Save the figure to the specified directory
plt.savefig("uncharacterized-9_Regulon.png", dpi=300, bbox_inches='tight')
...
plt.savefig("uncharacterized-5_Activity.png", dpi=300, bbox_inches='tight')
